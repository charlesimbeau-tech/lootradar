...
- Large umbrella catalog generation (`games-catalog.json`) for recommendations beyond active deals (~5k games default)
...
3. Run workflow: **Sync Supabase Config**
4. Use the sign-in box on `recommendations.html` (magic link auth)
