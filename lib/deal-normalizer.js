(function (root, factory) {
  ...
  function normalizeDeal(raw, stores = {}) {
    ...
    const releaseDate = metadata.released || raw.releaseDate || null;
    ...
    return {
      ...
      isBundle: /\b(bundle|collection|franchise pack)\b/i.test(title) || /\bedition\b.*\band\b.*\bedition\b/i.test(title),
